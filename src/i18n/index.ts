...
const ES_TRANSLATIONS: Record<string, string> = {
  ...
  'All clubs': 'Todas las academias',
  'WEEKLY GOAL': 'META SEMANAL',
  'Save goal': 'Guardar meta',
  'Current streak': 'Racha actual',
  'TREND (LAST 8 SESSIONS)': 'TENDENCIA (ÚLTIMAS 8 SESIONES)',
  'No session data in the selected range.': 'No hay sesiones en el rango seleccionado.',
  Favorites: 'Favoritas',
  'Drill plan mode': 'Modo plan de drills',
  'New tag (without #)': 'Nueva etiqueta (sin #)',
  'Save tag': 'Guardar etiqueta',
  'Plan name': 'Nombre del plan',
  'Save drill plan': 'Guardar plan de drills',
  'DATA BACKUP': 'RESPALDO DE DATOS',
  'Export backup (JSON)': 'Exportar respaldo (JSON)',
  'Import backup (JSON)': 'Importar respaldo (JSON)',
  'LOCAL TELEMETRY': 'TELEMETRÍA LOCAL',
  'Stored events': 'Eventos registrados',
  'Clear telemetry logs': 'Limpiar telemetría',
  'RECOMMENDED NEXT': 'SIGUIENTES RECOMENDACIONES',
}
